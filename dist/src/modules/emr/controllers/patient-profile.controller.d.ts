...
export declare class PatientProfileController {
    ...
    upsertPatientProfile(req: any, profileData: {
        dateOfBirth?: string;
        gender?: string;
        bloodType?: string;
        height?: number;
    ...
    addAllergy(req: any, allergyData: {
        allergen: string;
        severity: string;
        reaction: string;
        notes?: string;
    ...
    getPatientAllergies(req: any): Promise<{
        success: boolean;
        data: {
            id: string;
            createdAt: Date;
    ...
    addCurrentMedication(req: any, medicationData: {
        medicationName: string;
        dosage: string;
        frequency: string;
        route?: string;
    ...
    getPatientMedications(req: any): Promise<{
        success: boolean;
        data: {
            id: string;
            createdAt: Date;
